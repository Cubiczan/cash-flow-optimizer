...
export const workflows: Workflow[] = [
  ...
  },
  {
    ...
    description: 'Monitors Outlook via UiPath for invoice emails. Extracts PDF data, matches to POs, posts to Xero AP, and sends confirmation.',
    trigger: 'Event-driven',
    schedule: 'UiPath Outlook inbox trigger (invoice keyword)',
    lastRun: 'Today, 11:47 AM',
    nextRun: 'On next invoice email',
    status: 'idle',
    steps: [
      { name: 'UiPath: Outlook inbox watch (invoice keyword)', nodeType: 'API', status: 'pending' },
      ...
      { name: 'UiPath: Archive to OneDrive / reply via Outlook', nodeType: 'Output', status: 'pending' },
    ],
  },
  {
    id: 'wf3',
...
export const integrations: Integration[] = [
  ...
  },
  {
    ...
    status: 'connected',
    lastSync: 'just now',
    dataPoints: 'Outlook inbox reads · attachment routing · OneDrive handoff · job orchestration',
    authMethod: 'OAuth 2.0 client credentials',
    endpoint: 'cloud.uipath.com/identity_/connect/token',
  },
  {
    id: 'syft',
    name: 'Syft Analytics',
